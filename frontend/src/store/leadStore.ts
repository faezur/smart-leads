...
const useLeadStore = create<LeadState>()((set, get) => ({
  ...
  fetchLeads: async (filters) => {
    ...
    try {
      ...
      const message = getApiErrorMessage(error, 'Failed to fetch leads');
  ...
  createLead: async (data) => {
    ...
    try {
      ...
      const message = getApiErrorMessage(error, 'Failed to create lead');
  ...
  updateLead: async (id, data) => {
    ...
    try {
      ...
      const message = getApiErrorMessage(error, 'Failed to update lead');
      set({ error: message, isSubmitting: false });
      throw error;
    }
  },
  ...
  deleteLead: async (id) => {
    ...
    try {
      ...
      const message = getApiErrorMessage(error, 'Failed to delete lead');
      set({ error: message, isLoading: false });
      throw error;
    }
  },
  ...
  exportCSV: async () => {
    try {
      ...
      const message = getApiErrorMessage(error, 'Failed to export CSV');
      set({ error: message });
    }
  },
